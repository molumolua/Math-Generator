...
def process_train_data(data_list,output_path=None,prompt_type="generate_data",sections=["complex_problem","complex_solution"]):
    ...
    return problems
def main():
    file_path="/data2/xucaijun/Code-Math-Generator/data/enhance/MATH_test_origin.json"
    ...
    result_path=f"/data2/xucaijun/Code-Math-Generator/data/enhance/MATH_train.json"
